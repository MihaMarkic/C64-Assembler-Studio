...
public class DockFactory: Factory, IDockFactory
{
    ...
    public override IDocumentDock CreateDocumentDock() => _filesDocumentDockViewModel;
    ...
    public override IRootDock CreateLayout()
    {
            ...
            VisibleDockables = CreateList<IDockable>(
                new ToolDock
                {
                    ...
                    VisibleDockables = CreateList<IDockable>(errorMessages, buildOutput, debugOutput, errorsOutput,
                        breakpoints, memoryViewer, callStack),
        ...
        var rightDock = new ProportionalDock
        {
                ...
                new ToolDock
            {
                ...
                VisibleDockables = CreateList<IDockable>(registers),
    ...
    public override void InitLayout(IDockable layout)
    {
        ...
        {
            ["Root"] = () => RootDock,
            ["Documents"] = () => _filesDocumentDockViewModel,
        };
    ...
    {
        if (RootDock?.Close.CanExecute(null) == true)
        {
            RootDock.Close.Execute(null);
        }
    }
}